...
var RefIcon = React4.forwardRef(EyeOutlined2);
if (true) {
...
var OrderContext = React9.createContext(null);
...
function useDom(render, debug) {
  ...
  var appendedRef = React10.useRef(false);
  var queueCreate = React10.useContext(Context_default2);
  var _React$useState3 = React10.useState(EMPTY_LIST), _React$useState4 = _slicedToArray(_React$useState3, 2), queue = _React$useState4[0], setQueue = _React$useState4[1];
...
var Portal = React12.forwardRef(function(props, ref) {
  ...
  var _React$useState = React12.useState(open), _React$useState2 = _slicedToArray(_React$useState, 2), shouldRender = _React$useState2[0], setShouldRender = _React$useState2[1];
  ...
  var _React$useState3 = React12.useState(function() {
  ...
  if (ref) {
    reffedChildren = React12.cloneElement(children, {
      ref: mergedRef
    });
  }
  return React12.createElement(Context_default2.Provider, {
    value: queueCreate
...
var RefContext = React13.createContext({});
...
function getUseId() {
  var fullClone4 = _objectSpread2({}, React14);
  ...
  var CSSMotionList = function(_React$Component) {
    ...
    _createClass(CSSMotionList2, [{
      ...
      value: function render() {
        ...
        var Component3 = component || React24.Fragment;
        var motionProps = {};
        ...
        return React24.createElement(Component3, restProps, keyEntities.map(function(_ref2, index) {
...
var MemoChildren_default = React25.memo(function(_ref) {
...
var Panel = import_react9.default.forwardRef(function(props, ref) {
  ...
  var _React$useContext = import_react9.default.useContext(RefContext), panelRef = _React$useContext.panel;
  var mergedRef = useComposeRef(holderRef, panelRef);
  var sentinelStartRef = (0, import_react9.useRef)();
  var sentinelEndRef = (0, import_react9.useRef)();
  ...
  var footerNode = footer ? import_react9.default.createElement("div", {
    className: (0, import_classnames3.default)("".concat(prefixCls, "-footer"), modalClassNames === null || modalClassNames === void 0 ? void 0 : modalClassNames.footer),
    style: _objectSpread2({}, modalStyles === null || modalStyles === void 0 ? void 0 : modalStyles.footer)
  }, footer) : null;
  var headerNode = title ? import_react9.default.createElement("div", {
    className: (0, import_classnames3.default)("".concat(prefixCls, "-header"), modalClassNames === null || modalClassNames === void 0 ? void 0 : modalClassNames.header),
  ...
  var closableObj = (0, import_react9.useMemo)(function() {
    if (_typeof(closable) === "object" && closable !== null) {
      return closable;
    }
    if (closable) {
      return {
        closeIcon: closeIcon !== null && closeIcon !== void 0 ? closeIcon : import_react9.default.createElement("span", {
  ...
  var closerNode = closable ? import_react9.default.createElement("button", _extends({
    type: "button",
    onClick: onClose,
    "aria-label": "Close"
  }, ariaProps, {
  ...
  var content = import_react9.default.createElement("div", {
    className: (0, import_classnames3.default)("".concat(prefixCls, "-content"), modalClassNames === null || modalClassNames === void 0 ? void 0 : modalClassNames.content),
    style: modalStyles === null || modalStyles === void 0 ? void 0 : modalStyles.content
  }, closerNode, headerNode, import_react9.default.createElement("div", _extends({
    className: (0, import_classnames3.default)("".concat(prefixCls, "-body"), modalClassNames === null || modalClassNames === void 0 ? void 0 : modalClassNames.body),
  ...
  return import_react9.default.createElement("div", {
    ...
    tabIndex: 0,
    style: entityStyle
  }, import_react9.default.createElement(MemoChildren_default, {
    shouldUpdate: visible || forceRender
  }, modalRender ? modalRender(content) : content)), import_react9.default.createElement("div", {
    tabIndex: 0,
    ref: sentinelEndRef,
    style: sentinelStyle
  }));
...
// node_modules/rc-dialog/es/Dialog/Content/index.js
var Content = React27.forwardRef(function(props, ref) {
  ...
  var dialogRef = (0, import_react10.useRef)();
  var _React$useState = React27.useState(), _React$useState2 = _slicedToArray(_React$useState, 2), transformOrigin = _React$useState2[0], setTransformOrigin = _React$useState2[1];
  var contentStyle = {};
  if (transformOrigin) {
  ...
  return React27.createElement(es_default2, {
    ...
    return React27.createElement(Panel_default, _extends({}, props, {
      ref,
      title,
      ariaId,
      prefixCls,
...
var Mask = function Mask2(props) {
  ...
  return React28.createElement(es_default2, {
    ...
    return React28.createElement("div", _extends({
      ...
      className: (0, import_classnames5.default)("".concat(prefixCls, "-mask"), motionClassName, className)
    }, maskProps));
  });
};
...
var Dialog = function Dialog2(props) {
  ...
  var lastOutSideActiveElementRef = (0, import_react11.useRef)();
  var wrapperRef = (0, import_react11.useRef)();
  var contentRef = (0, import_react11.useRef)();
  var _React$useState = React29.useState(visible), _React$useState2 = _slicedToArray(_React$useState, 2), animatedVisible = _React$useState2[0], setAnimatedVisible = _React$useState2[1];
  ...
  var contentClickRef = (0, import_react11.useRef)(false);
  var contentTimeoutRef = (0, import_react11.useRef)();
  ...
  return React29.createElement("div", _extends({
    className: (0, import_classnames6.default)("".concat(prefixCls, "-root"), rootClassName)
  }, pickAttrs(props, {
    data: true
  })), React29.createElement(Mask_default, {
    prefixCls,
  ...
  }), React29.createElement("div", _extends({
    tabIndex: -1,
    onKeyDown: onWrapperKeyDown,
    className: (0, import_classnames6.default)("".concat(prefixCls, "-wrap"), wrapClassName, modalClassNames === null || modalClassNames === void 0 ? void 0 : modalClassNames.wrapper),
    ref: wrapperRef,
    onClick: onWrapperClick,
    style: mergedStyle
  }, wrapProps), React29.createElement(Content_default, _extends({}, props, {
...
var DialogWrap = function DialogWrap2(props) {
  ...
  var _React$useState = React30.useState(visible), _React$useState2 = _slicedToArray(_React$useState, 2), animatedVisible = _React$useState2[0], setAnimatedVisible = _React$useState2[1];
  var refContext = React30.useMemo(function() {
    return {
      panel: panelRef
    };
  }, [panelRef]);
  ...
  return React30.createElement(RefContext.Provider, {
    value: refContext
  ...
  }, React30.createElement(Dialog_default, _extends({}, props, {
    destroyOnClose,
...
var PreviewGroupContext = React31.createContext(null);
...
var Operations = function Operations2(props) {
  ...
  var groupContext = (0, import_react12.useContext)(PreviewGroupContext);
  ...
  var renderOperation = React32.useCallback(function(_ref) {
    var type = _ref.type, disabled = _ref.disabled, onClick = _ref.onClick, icon = _ref.icon;
    return React32.createElement("div", {
      key: type,
      className: (0, import_classnames7.default)(toolClassName, "".concat(prefixCls, "-operations-operation-").concat(type), _defineProperty({}, "".concat(prefixCls, "-operations-operation-disabled"), !!disabled)),
      onClick
    }, icon);
  ...
  var toolbarNode = React32.createElement("div", {
    className: "".concat(prefixCls, "-operations")
  }, flipYNode, flipXNode, rotateLeftNode, rotateRightNode, zoomOutNode, zoomInNode);
  return React32.createElement(es_default2, {
    visible,
    ...
    return React32.createElement(es_default, {
      ...
      className: (0, import_classnames7.default)("".concat(prefixCls, "-operations-wrapper"), className, rootClassName),
      style: _objectSpread2(_objectSpread2({}, style2), {}, {
        zIndex
      })
    }, closeIcon === null ? null : React32.createElement("button", {
      className: "".concat(prefixCls, "-close"),
      onClick: onClose
    }, closeIcon || close), showSwitch && React32.createElement(React32.Fragment, null, React32.createElement("div", {
      className: (0, import_classnames7.default)("".concat(prefixCls, "-switch-left"), _defineProperty({}, "".concat(prefixCls, "-switch-left-disabled"), current === 0)),
      onClick: function onClick(e) {
        return handleActive(e, -1);
      }
    }, left), React32.createElement("div", {
      className: (0, import_classnames7.default)("".concat(prefixCls, "-switch-right"), _defineProperty({}, "".concat(prefixCls, "-switch-right-disabled"), current === count - 1)),
      onClick: function onClick(e) {
        return handleActive(e, 1);
      }
    }, right)), React32.createElement("div", {
      className: "".concat(prefixCls, "-footer")
    }, showProgress && React32.createElement("div", {
      className: "".concat(prefixCls, "-progress")
    }, countRender ? countRender(current + 1, count) : React32.createElement("bdi", null, "".concat(current + 1, " / ").concat(count))), toolbarRender ? toolbarRender(toolbarNode, _objectSpread2(_objectSpread2({
      icons: {
...
function useImageTransform(imgRef, minScale, maxScale, onTransform) {
  var frame = (0, import_react13.useRef)(null);
  var queue = (0, import_react13.useRef)([]);
  var _useState = (0, import_react13.useState)(initialTransform), _useState2 = _slicedToArray(_useState, 2), transform = _useState2[0], setTransform = _useState2[1];
...
function useMouseEvent(imgRef, movable, visible, scaleStep, transform, updateTransform, dispatchZoomChange) {
  ...
  var _useState = (0, import_react14.useState)(false), _useState2 = _slicedToArray(_useState, 2), isMoving = _useState2[0], setMoving = _useState2[1];
  var startPositionInfo = (0, import_react14.useRef)({
    diffX: 0,
    diffY: 0,
    transformX: 0,
    transformY: 0
...
function useStatus2(_ref) {
  ...
  var _useState = (0, import_react15.useState)(isCustomPlaceholder ? "loading" : "normal"), _useState2 = _slicedToArray(_useState, 2), status = _useState2[0], setStatus = _useState2[1];
  var isLoaded = (0, import_react15.useRef)(false);
...
function useTouchEvent(imgRef, movable, visible, minScale, transform, updateTransform, dispatchZoomChange) {
  var rotate = transform.rotate, scale = transform.scale, x = transform.x, y = transform.y;
  var _useState = (0, import_react16.useState)(false), _useState2 = _slicedToArray(_useState, 2), isTouching = _useState2[0], setIsTouching = _useState2[1];
  var touchPointInfo = (0, import_react16.useRef)({
    point1: {
      x: 0,
      y: 0
    },
...
// node_modules/rc-image/es/Preview.js
var _excluded5 = ["fallback", "src", "imgRef"];
...
var PreviewImage = function PreviewImage2(_ref) {
  var fallback = _ref.fallback, src = _ref.src, imgRef = _ref.imgRef, props = _objectWithoutProperties(_ref, _excluded5);
  var _useStatus = useStatus2({
    src,
    fallback
  }), _useStatus2 = _slicedToArray(_useStatus, 2), getImgRef = _useStatus2[0], srcAndOnload = _useStatus2[1];
  return import_react17.default.createElement("img", _extends({
...
var Preview = function Preview2(props) {
  ...
  var imgRef = (0, import_react17.useRef)();
  var groupContext = (0, import_react17.useContext)(PreviewGroupContext);
  var showLeftOrRightSwitches = groupContext && count > 1;
  var showOperationsProgress = groupContext && count >= 1;
  var _useState = (0, import_react17.useState)(true), _useState2 = _slicedToArray(_useState, 2), enableTransition = _useState2[0], setEnableTransition = _useState2[1];
  ...
  var wrapClassName = (0, import_classnames8.default)(_defineProperty({}, "".concat(prefixCls, "-moving"), isMoving));
  ...
  var imgNode = import_react17.default.createElement(PreviewImage, _extends({}, imgCommonProps, {
    width: props.width,
    height: props.height,
    imgRef,
  ...
  return import_react17.default.createElement(import_react17.default.Fragment, null, import_react17.default.createElement(es_default3, _extends({
    transitionName,
    maskTransitionName,
    closable: false,
    keyboard: true,
    ...
    current
  } : {})) : imgNode)), import_react17.default.createElement(Operations_default, {
    visible,
    transform,
    maskTransitionName,
    closeIcon,
...
function usePreviewItems(items) {
  var _React$useState = React34.useState({}), _React$useState2 = _slicedToArray(_React$useState, 2), images = _React$useState2[0], setImages = _React$useState2[1];
  var registerImage = React34.useCallback(function(id, data) {
  ...
  var mergedItems = React34.useMemo(function() {
    if (items) {
...
// node_modules/rc-image/es/PreviewGroup.js
var _excluded6 = ["visible", "onVisibleChange", "getContainer", "current", "movable", "minScale", "maxScale", "countRender", "closeIcon", "onChange", "onTransform", "toolbarRender", "imageRender"];
var _excluded24 = ["src"];
var Group = function Group2(_ref) {
  ...
  var _ref2 = _typeof(preview) === "object" ? preview : {}, previewVisible = _ref2.visible, onVisibleChange = _ref2.onVisibleChange, getContainer2 = _ref2.getContainer, currentIndex = _ref2.current, movable = _ref2.movable, minScale = _ref2.minScale, maxScale = _ref2.maxScale, countRender = _ref2.countRender, closeIcon = _ref2.closeIcon, onChange = _ref2.onChange, onTransform = _ref2.onTransform, toolbarRender = _ref2.toolbarRender, imageRender = _ref2.imageRender, dialogProps = _objectWithoutProperties(_ref2, _excluded6);
  ...
  var _useState = (0, import_react18.useState)(false), _useState2 = _slicedToArray(_useState, 2), keepOpenIndex = _useState2[0], setKeepOpenIndex = _useState2[1];
  ...
  var _useState3 = (0, import_react18.useState)(null), _useState4 = _slicedToArray(_useState3, 2), mousePosition = _useState4[0], setMousePosition = _useState4[1];
  var onPreviewFromImage = React35.useCallback(function(id, imageSrc, mouseX, mouseY) {
  ...
  var previewGroupContext = React35.useMemo(function() {
    return {
      register,
      onPreview: onPreviewFromImage
    };
  }, [register, onPreviewFromImage]);
  return React35.createElement(PreviewGroupContext.Provider, {
    value: previewGroupContext
  }, children, React35.createElement(Preview_default, _extends({
...
function useRegisterImage(canPreview, data) {
  ...
  var groupContext = React36.useContext(PreviewGroupContext);
  var registerData = {
    data,
    canPreview
  };
...
// node_modules/rc-image/es/Image.js
var _excluded7 = ["src", "alt", "onPreviewClose", "prefixCls", "previewPrefixCls", "placeholder", "fallback", "width", "height", "style", "preview", "className", "onClick", "onError", "wrapperClassName", "wrapperStyle", "rootClassName"];
...
var ImageInternal = function ImageInternal2(props) {
  var imgSrc = props.src, alt = props.alt, onInitialPreviewClose = props.onPreviewClose, _props$prefixCls = props.prefixCls, prefixCls = _props$prefixCls === void 0 ? "rc-image" : _props$prefixCls, _props$previewPrefixC = props.previewPrefixCls, previewPrefixCls = _props$previewPrefixC === void 0 ? "".concat(prefixCls, "-preview") : _props$previewPrefixC, placeholder = props.placeholder, fallback = props.fallback, width = props.width, height = props.height, style2 = props.style, _props$preview = props.preview, preview = _props$preview === void 0 ? true : _props$preview, className = props.className, onClick = props.onClick, onError = props.onError, wrapperClassName = props.wrapperClassName, wrapperStyle = props.wrapperStyle, rootClassName = props.rootClassName, otherProps = _objectWithoutProperties(props, _excluded7);
  ...
  var _useState = (0, import_react19.useState)(null), _useState2 = _slicedToArray(_useState, 2), mousePosition = _useState2[0], setMousePosition = _useState2[1];
  var groupContext = (0, import_react19.useContext)(PreviewGroupContext);
  var canPreview = !!preview;
  var onPreviewClose = function onPreviewClose2() {
    setShowPreview(false);
    setMousePosition(null);
  };
  var wrapperClass = (0, import_classnames9.default)(prefixCls, wrapperClassName, rootClassName, _defineProperty({}, "".concat(prefixCls, "-error"), status === "error"));
  var imgCommonProps = (0, import_react19.useMemo)(function() {
    var obj = {};
  ...
  var registerData = (0, import_react19.useMemo)(function() {
  ...
  return React37.createElement(React37.Fragment, null, React37.createElement("div", _extends({}, otherProps, {
  ...
  }), React37.createElement("img", _extends({}, imgCommonProps, {
    className: (0, import_classnames9.default)("".concat(prefixCls, "-img"), _defineProperty({}, "".concat(prefixCls, "-img-placeholder"), placeholder === true), className),
    style: _objectSpread2({
      height
    }, style2),
    ref: getImgRef
    ...
    height,
    onError
  })), status === "loading" && React37.createElement("div", {
    "aria-hidden": "true",
    className: "".concat(prefixCls, "-placeholder")
  }, placeholder), previewMask && canPreview && React37.createElement("div", {
    className: (0, import_classnames9.default)("".concat(prefixCls, "-mask"), maskClassName),
    style: {
      display: (style2 === null || style2 === void 0 ? void 0 : style2.display) === "none" ? "none" : void 0
    }
  }, previewMask)), !groupContext && canPreview && React37.createElement(Preview_default, _extends({
    "aria-hidden": !isShowPreview,
    visible: isShowPreview,
    prefixCls: previewPrefixCls,
    onClose: onPreviewClose,
...
var RefIcon2 = React38.forwardRef(CloseOutlined2);
if (true) {
...
var WarningContext = React39.createContext({});
var devUseWarning = true ? (component) => {
  const {
    strict
  } = React39.useContext(WarningContext);
...
var useClosable = (propCloseCollection, contextCloseCollection, fallbackCloseCollection = EmptyFallbackCloseCollection) => {
  ...
  const mergedFallbackCloseCollection = import_react21.default.useMemo(() => Object.assign({
    closeIcon: import_react21.default.createElement(CloseOutlined_default2, null)
...
function mergeClassNames(schema, ...classNames9) {
  const mergedSchema = schema || {};
  return classNames9.reduce((acc, cur) => {
...
function useSemanticClassNames(schema, ...classNames9) {
  return React44.useMemo(() => mergeClassNames.apply(void 0, [schema].concat(classNames9)), [classNames9, schema]);
}
...
var usePatchElement = () => {
  const [elements, setElements] = React45.useState([]);
  const patchElement = React45.useCallback((element) => {
...
var useSyncState2 = (initialValue) => {
  const ref = React46.useRef(initialValue);
...
var StyleContext = React47.createContext({
  hashPriority: "low",
  cache: createCache(),
  defaultCache: true
});
...
var fullClone = _objectSpread2({}, React48);
var useInsertionEffect = fullClone.useInsertionEffect;
var useInsertionEffectPolyfill = function useInsertionEffectPolyfill2(renderEffect, effect, deps) {
  React48.useMemo(renderEffect, deps);
  useLayoutEffect_default(function() {
    return effect(true);
  }, deps);
};
...
var fullClone2 = _objectSpread2({}, React49);
...
function useGlobalCache(prefix2, keyPath, cacheFn, onCacheRemove, onCacheEffect) {
  var _React$useContext = React50.useContext(StyleContext_default), globalCache = _React$useContext.cache;
...
function useCacheToken(theme, tokens) {
  ...
  var _useContext = (0, import_react25.useContext)(StyleContext_default), instanceId = _useContext.cache.instanceId, container = _useContext.container;
          ...
          default:
            ...
            if (character2 === 123)
              if (offset2 === 0)
                ...
                if (offset2) parse(value, reference, reference, rule && append(ruleset(value, reference, reference, 0, 0, rules, points, type, rules, props = [], length2, children), children), rules, children, length2, points, rule ? props : children);
...
function useStyleRegister(info, styleFn) {
  ...
  return function(node2) {
    ...
    if (!ssrInline || isMergedClientSide || !defaultCache) {
      styleNode = React51.createElement(Empty, null);
    } else {
      styleNode = React51.createElement("style", _extends({}, _defineProperty(_defineProperty({}, ATTR_TOKEN, cachedTokenKey), ATTR_MARK, cachedStyleId), {
        dangerouslySetInnerHTML: {
          __html: cachedStyleStr
        }
      }));
    }
    return React51.createElement(React51.Fragment, null, styleNode, node2);
  };
}
...
var useCSSVarRegister = function useCSSVarRegister2(config, fn) {
  ...
  var _useContext = (0, import_react26.useContext)(StyleContext_default), instanceId = _useContext.cache.instanceId, container = _useContext.container;
  var tokenKey = token2._tokenKey;
...
var DesignTokenContext = import_react27.default.createContext(defaultConfig);
...
function useToken() {
  const {
    ...
    override,
    cssVar
  } = import_react28.default.useContext(DesignTokenContext);
...
var validateMessagesContext_default = (0, import_react31.createContext)(void 0);
...
var ConfigContext = React56.createContext({
...
function useComponentConfig(propName) {
  const context = React56.useContext(ConfigContext);
  const {
    getPrefixCls,
    direction,
    getPopupContainer
...
function useUniqueMemo(memoFn, deps) {
  return import_react33.default.useMemo(function() {
...
function genStyleUtils(config) {
  ...
  function genCSSVarRegister(component, getDefaultToken, options) {
    ...
    var useCSSVar = function useCSSVar2(rootCls) {
      ...
      return [function(node2) {
        return injectStyle && cssVar ? import_react34.default.createElement(import_react34.default.Fragment, null, import_react34.default.createElement(CSSVarRegister, {
          rootCls,
          cssVar,
          component
        }), node2) : node2;
...
var fullClone3 = Object.assign({}, React61);
var {
  useId: useId2
} = fullClone3;
var useEmptyId = () => "";
...
var MotionCacheContext = React62.createContext(true);
if (true) {
  MotionCacheContext.displayName = "MotionCacheContext";
}
function MotionWrapper(props) {
  const parentMotion = React62.useContext(MotionCacheContext);
  const {
    children
  } = props;
  const [, token2] = useToken();
  ...
  const needWrapMotionProviderRef = React62.useRef(false);
  needWrapMotionProviderRef.current || (needWrapMotionProviderRef.current = parentMotion !== motion);
  if (needWrapMotionProviderRef.current) {
    return React62.createElement(MotionCacheContext.Provider, {
      value: motion
    }, React62.createElement(MotionProvider, {
      motion
    }, children));
  }
  return children;
...
var ProviderChildren = (props) => {
  ...
  const getPrefixCls = React64.useCallback((suffixCls, customizePrefixCls) => {
    const {
      prefixCls
    } = props;
    if (customizePrefixCls) {
  ...
  const {
    layer
  } = React64.useContext(StyleContext_default);
  const memoIconContextValue = React64.useMemo(() => ({
    prefixCls: iconPrefixCls,
    csp,
    layer: layer ? "antd" : void 0
  }), [iconPrefixCls, csp, layer]);
  let childNode = React64.createElement(React64.Fragment, null, React64.createElement(PropWarning_default, {
    dropdownMatchSelectWidth
  }), children);
  const validateMessages = React64.useMemo(() => {
    var _a, _b, _c, _d;
  ...
  if (Object.keys(validateMessages).length > 0) {
    childNode = React64.createElement(validateMessagesContext_default.Provider, {
      value: validateMessages
    }, childNode);
  }
  if (locale5) {
    childNode = React64.createElement(locale_default, {
      locale: locale5,
      _ANT_MARK__: ANT_MARK
    }, childNode);
  }
  if (iconPrefixCls || csp) {
    childNode = React64.createElement(Context_default.Provider, {
      value: memoIconContextValue
    }, childNode);
  }
  if (componentSize) {
    childNode = React64.createElement(SizeContextProvider, {
      size: componentSize
    }, childNode);
  }
  childNode = React64.createElement(MotionWrapper, null, childNode);
  const memoTheme = React64.useMemo(() => {
  ...
  if (theme) {
    childNode = React64.createElement(DesignTokenContext.Provider, {
      value: memoTheme
    }, childNode);
  }
  if (memoedConfig.warning) {
    childNode = React64.createElement(WarningContext.Provider, {
      value: memoedConfig.warning
    }, childNode);
  }
  if (componentDisabled !== void 0) {
    childNode = React64.createElement(DisabledContextProvider, {
      disabled: componentDisabled
    }, childNode);
  }
  return React64.createElement(ConfigContext.Provider, {
    value: memoedConfig
  }, childNode);
};
var ConfigProvider = (props) => {
  const context = React64.useContext(ConfigContext);
  const antLocale = React64.useContext(context_default);
  return React64.createElement(ProviderChildren, Object.assign({
...
var RefIcon3 = React65.forwardRef(LeftOutlined2);
if (true) {
...
var RefIcon4 = React66.forwardRef(RightOutlined2);
if (true) {
...
var RefIcon5 = React67.forwardRef(RotateLeftOutlined2);
if (true) {
  RefIcon5.displayName = "RotateLeftOutlined";
}
var RotateLeftOutlined_default2 = RefIcon5;
...
var RefIcon6 = React68.forwardRef(RotateRightOutlined2);
if (true) {
  RefIcon6.displayName = "RotateRightOutlined";
}
var RotateRightOutlined_default2 = RefIcon6;
...
var RefIcon7 = React69.forwardRef(SwapOutlined2);
if (true) {
  RefIcon7.displayName = "SwapOutlined";
}
var SwapOutlined_default2 = RefIcon7;
...
var RefIcon8 = React70.forwardRef(ZoomInOutlined2);
if (true) {
  RefIcon8.displayName = "ZoomInOutlined";
}
var ZoomInOutlined_default2 = RefIcon8;
...
var RefIcon9 = React71.forwardRef(ZoomOutOutlined2);
if (true) {
  RefIcon9.displayName = "ZoomOutOutlined";
}
var ZoomOutOutlined_default2 = RefIcon9;
...
var icons = {
  rotateLeft: React72.createElement(RotateLeftOutlined_default2, null),
  rotateRight: React72.createElement(RotateRightOutlined_default2, null),
  zoomIn: React72.createElement(ZoomInOutlined_default2, null),
  zoomOut: React72.createElement(ZoomOutOutlined_default2, null),
  close: React72.createElement(CloseOutlined_default2, null),
  left: React72.createElement(LeftOutlined_default2, null),
  right: React72.createElement(RightOutlined_default2, null),
  flipX: React72.createElement(SwapOutlined_default2, null),
  flipY: React72.createElement(SwapOutlined_default2, {
    rotate: 90
  })
};
var InternalPreviewGroup = (_a) => {
  ...
  const memoizedIcons = React72.useMemo(() => Object.assign(Object.assign({}, icons), {
    left: direction === "rtl" ? React72.createElement(RightOutlined_default2, null) : React72.createElement(LeftOutlined_default2, null),
    right: direction === "rtl" ? React72.createElement(LeftOutlined_default2, null) : React72.createElement(RightOutlined_default2, null)
  }), [direction]);
  const mergedPreview = React72.useMemo(() => {
    var _a2;
    if (preview === false) {
      return preview;
    }
    const _preview = typeof preview === "object" ? preview : {};
    const mergedRootClassName = (0, import_classnames11.default)(hashId, cssVarCls, rootCls, (_a2 = _preview.rootClassName) !== null && _a2 !== void 0 ? _a2 : "");
  ...
  return wrapCSSVar(React72.createElement(es_default4.PreviewGroup, Object.assign({
...
var Image = (props) => {
  const {
    ...
    style: style2,
    fallback
  } = props, otherProps = __rest5(props, ["prefixCls", "preview", "className", "rootClassName", "style", "fallback"]);
  if (true) {
    const warning4 = devUseWarning("Image");
    warning4.deprecated(!(preview && typeof preview === "object" && "destroyOnClose" in preview), "destroyOnClose", "destroyOnHidden");
  }
  const {
    getPrefixCls,
  ...
  const rootCls = useCSSVarCls_default(prefixCls);
  const [wrapCSSVar, hashId, cssVarCls] = style_default2(prefixCls, rootCls);
  const mergedRootClassName = (0, import_classnames12.default)(rootClassName, hashId, cssVarCls, rootCls);
  const mergedClassName = (0, import_classnames12.default)(className, hashId, contextClassName);
  const [zIndex] = useZIndex("ImagePreview", typeof preview === "object" ? preview.zIndex : void 0);
  const mergedPreview = React73.useMemo(() => {
    if (preview === false) {
      return preview;
    }
    const _preview = typeof preview === "object" ? preview : {};
    const {
      ...
      destroyOnClose,
      destroyOnHidden
    } = _preview, restPreviewProps = __rest5(_preview, ["getContainer", "closeIcon", "rootClassName", "destroyOnClose", "destroyOnHidden"]);
    return Object.assign(Object.assign({
      mask: React73.createElement("div", {
        className: `${prefixCls}-mask-info`
      }, React73.createElement(EyeOutlined_default2, null), imageLocale === null || imageLocale === void 0 ? void 0 : imageLocale.preview),
      icons
    }, restPreviewProps), {
      // TODO: In the future, destroyOnClose in rc-image needs to be upgrade to destroyOnHidden
      destroyOnClose: destroyOnHidden !== null && destroyOnHidden !== void 0 ? destroyOnHidden : destroyOnClose,
      rootClassName: (0, import_classnames12.default)(mergedRootClassName, rootClassName2),
  ...
  return wrapCSSVar(React73.createElement(es_default4, Object.assign({
    prefixCls,
    preview: mergedPreview,
    rootClassName: mergedRootClassName,
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-UMWDPPGO.js.map
